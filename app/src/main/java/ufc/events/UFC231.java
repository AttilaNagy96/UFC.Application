...
public class UFC231 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyADJ11JXrwcuUQi7z4rfm7tdCD5v3EPWkg";
    public static final String VIDEO_ID = "p_g_PX9TYr0";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ufc231);
