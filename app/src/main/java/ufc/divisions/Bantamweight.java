...
public class Bantamweight extends AppCompatActivity {

    int[] IMAGES = {R.drawable.tj, R.drawable.cody, R.drawable.cruz};
    String[] NAMES = {"TJ Dillashaw", "Cody Garbrandt", "Dominick Cruz"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bantamweight);
