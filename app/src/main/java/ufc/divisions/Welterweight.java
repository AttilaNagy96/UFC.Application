...
public class Welterweight extends AppCompatActivity {
    ...
    int[] IMAGES = {R.drawable.woodley, R.drawable.covington, R.drawable.wonderboy, R.drawable.lawler};
    String[] NAMES = {"Tyron Woodley", "Colby Covington", "Stephen Thompson", "Robbie Lawler"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2", "Ranked No.3"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_welterweight);
