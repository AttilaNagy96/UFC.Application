...
public class Middleweight extends AppCompatActivity {
    ...
    int[] IMAGES = {R.drawable.whittaker, R.drawable.yoel_romero, R.drawable.rockhold};
    String[] NAMES = {"Robert Whittaker", "Yoel Romero", "Luke Rockhold"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_middleweight);
