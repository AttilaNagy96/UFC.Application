...
public class Featherweight extends AppCompatActivity {

    int[] IMAGES = {R.drawable.holloway, R.drawable.ortega, R.drawable.aldo};
    String[] NAMES = {"Max Holloway", "Brian Ortega", "Jose Aldo"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_featherweight);
