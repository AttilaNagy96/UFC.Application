...
public class LHweight extends AppCompatActivity {

    int[] IMAGES = {R.drawable.dc, R.drawable.jones, R.drawable.gustafson};
    String[] NAMES = {"Daniel Cormier", "Jon Jones", "Alexander Gustafson"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lhweight);
