...
public class Heavyweight extends AppCompatActivity {

    int[] IMAGES = {R.drawable.dc, R.drawable.miocic, R.drawable.d_lewis};
    String[] NAMES = {"Daniel Cormier", "Stipe Miocic", "Derrick Lewis"};
    String [] DESCRIPTIONS = {"Champion", "Ranked No.1", "Ranked No.2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_heavyweight);
