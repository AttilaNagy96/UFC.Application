...
public class Flyweight extends AppCompatActivity {

    int[] IMAGES = {R.drawable.cejudo, R.drawable.demetrious, R.drawable.s_pettis};
    String[] NAMES = {"Henry Cejudo", "Demetrious Johnson", "Sergio Pettis"};
